...
const defaultModuleRoots = []

type ResolveOptions = {
  extensions?: typeof defaultExtensions,
  moduleRoots?: typeof defaultModuleRoots,
}
...
function loadModuleRoots(basedir, moduleRoots) {
...
export default function resolveModule(
  ...
  const resolveOptions = { basedir, extensions, moduleRoots }
